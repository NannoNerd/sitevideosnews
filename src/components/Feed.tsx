          ...
          <main className="container mx-auto px-4 py-8">
            ...
            <div className="max-w-7xl mx-auto">
              {filteredContent.length === 0 ? (
                ...
                <Card key={item.id} className="hover:shadow-lg transition-shadow flex flex-col cursor-pointer">
                  <Link to={item.type === 'post' ? `/post/${item.slug}` : `/video/${item.slug}`} className="flex flex-col h-full">
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-3 gap-8 items-center max-w-7xl mx-auto">
              ...
              <div className={`transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} flex justify-center`}>
                <img src={civil3dImage} alt="Autocad Civil 3D" className="w-full max-w-sm rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300" />
              </div>
        ...
        <section className="py-16 bg-slate-900 text-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <div className="mb-12">
                <Button onClick={handleGeneratePositiveMessage} disabled={generatingPositiveMessage} className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:shadow-purple-500/25 transition-all duration-300">
                  <Sparkles className="w-5 h-5 mr-2" />
                  {generatingPositiveMessage ? 'Gerando...' : 'Gerar Mensagem Positiva'}
                </Button>
                
                {/* Mensagem Positiva */}
                {positiveMessage && <div className="mt-8 max-w-2xl mx-auto">
                    <div className="relative">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
              ...
              <Card className="bg-gradient-to-br from-slate-800 to-slate-700 border-slate-600 hover:shadow-xl transition-all duration-300 hover:scale-105">
                <div className="h-48 rounded-t-lg overflow-hidden">
                  <img src={mentalidadeVencedoraImage} alt="Mentalidade vencedora" className="w-full h-full object-cover" />
                </div>
                <CardContent className="p-6 text-center">
              ...
              <Card className="bg-gradient-to-br from-slate-800 to-slate-700 border-slate-600 hover:shadow-xl transition-all duration-300 hover:scale-105">
                <div className="h-48 rounded-t-lg overflow-hidden">
                  <img src={focoDisciplinaImage} alt="Foco e disciplina" className="w-full h-full object-cover" />
                </div>
                <CardContent className="p-6 text-center">
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-3 gap-8 items-center max-w-7xl mx-auto">
              ...
              <div className={`transition-all duration-1000 delay-200 ${mounted ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                <img src={criptosImage} alt="Criptomoedas" className="w-full max-w-md mx-auto rounded-lg shadow-lg" />
              </div>
                ...
                <CardContent className="text-center">
                  ...
                  <div className="flex justify-center items-center mt-8 space-x-4">
                    ...
                    <div className="flex space-x-2">
                      {testimonials.map((_, index) => <div key={index} className={`w-3 h-3 rounded-full transition-all duration-300 ${index === currentTestimonial ? 'bg-cyan-400' : 'bg-gray-600'}`} />)}
                    </div>
                    
                    <Button variant="ghost" size="sm" onClick={nextTestimonial} className="text-cyan-400 hover:text-cyan-300 hover:bg-slate-700">
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
              ...
              <div>
                ...
                <p className="text-gray-300">Email: contato@ivofernandesnews.com.br</p>
              </div>
            </div>
        ...
        <Dialog open={iaOpen} onOpenChange={setIaOpen}>
          <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <Textarea placeholder={iaMode === 'engenharia' ? 'Ex: Como criar um script para automatizar a criação de perfis longitudinais no AutoCAD Civil 3D?' : iaMode === 'crypto' ? 'Ex: Qual a diferença entre Bitcoin e Ethereum?' : 'Ex: Como posso melhorar minha produtividade no trabalho?'} value={iaPrompt} onChange={e => setIaPrompt(e.target.value)} rows={4} />

              <Button onClick={handleGenerateIaCommand} disabled={iaLoading} className="w-full">
                {iaLoading ? 'Gerando...' : 'Gerar Resposta'}
              </Button>

              {iaResult && <div className="mt-6 p-4 border rounded-lg bg-muted/50">
                ...
                __html: sanitizeHtml(iaResult, 'content')
              }} />
                </div>}
            </div>
          </DialogContent>
